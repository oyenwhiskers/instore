            ...
            <tbody>
                @forelse ($promoters as $promoter)
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('customer.kpi-targets.edit', $promoter) }}" class="btn btn-ghost">Set Targets</a>
                            <a href="{{ route('customer.kpi-progress.show', $promoter) }}" class="btn btn-ghost">View Progress</a>
                        </td>
                    </tr>
                @empty
                    <tr>
