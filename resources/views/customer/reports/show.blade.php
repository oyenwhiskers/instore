...
@section('page_desc', 'Audit-ready view with itemized breakdown and totals.')
@section('page_actions')
    <a href="{{ route('customer.reports.index') }}" class="btn btn-secondary">Back to Reports</a>
@endsection

@section('content')
<div class="split-view">
    <div class="card">
        <div class="stat-label">Report Summary</div>
