...
@section('page_desc', 'Filter and review hourly activity reports across your locations.')
            ...
            <tbody>
                @forelse ($reports as $report)
                    ...
                    <tr>
                        ...
                        <td><a href="{{ route('customer.reports.show', $report) }}" class="btn btn-ghost">View</a></td>
                    </tr>
                @empty
                    <tr>
